...
public class OutfitController {
    ...
    public static void printFieldsExceptListDouble(Object dto) {
    ...
    public ResponseEntity<Map<OutfitKey, OutfitDto>> recommendOutfit(@RequestBody OutfitRequest request) throws IOException {
        ...
        for (Map.Entry<OutfitKey, OutfitDto> entry : outfits.entrySet()) {
            System.out.println("=== Outfit Key: " + entry.getKey() + " ===");
            OutfitDto dto = entry.getValue();

            System.out.println("제목: " + dto.getTitle());
            System.out.println("설명: " + dto.getDescription());

            Map<ClothesKey, Map<String, String>> cMap = dto.getClothes();
            for (Map.Entry<ClothesKey, Map<String, String>> clothesEntry : cMap.entrySet()) {
                ClothesKey clothesKey = clothesEntry.getKey();
                Map<String, String> clothesInfo = clothesEntry.getValue();
                String productUrl = clothesInfo.get("productUrl");
                ClothesDto clothesDto = coordinationService.getClothes(productUrl);
                System.out.println("[" + clothesKey + "]");
                printFieldsExceptListDouble(clothesDto);
            }
            System.out.println("====================================");
        }
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<List<Map<ClothesKey, Map<String, String>>>> getFavoriteCoordinations() {
        String userId = getCurrentUserId();
        List<Map<ClothesKey, Map<String, String>>> favoriteCoordinations = coordinationService.getFavoriteCoordinations(userId);
