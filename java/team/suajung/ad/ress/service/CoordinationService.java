...
public class CoordinationService {
    ...
    public String getBaseJsons(Integer temperature, UniqueCoordinationType uniqueCoordinationType) throws IOException {
        ...
        if (uniqueCoordinationType == UniqueCoordinationType.LAYERED_COORDINATION) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String path = "src/main/resources/layeredBaseJson/layeredBaseJson" + degree + "Degrees/layeredBaseJson" + degree + "Degrees" + (i + 1) + ".json";

                String baseJson = Files.readString(Paths.get(path));

                baseJsons.append(baseJson);
            }
            ...
            for (int i = 0; i < count; i++) {
                ...
                String path = "src/main/resources/baseJson/baseJson" + degree + "Degrees/baseJson" + degree + "Degrees" + (i + 1) + ".json";
    ...
    public List<String> getPriorityList(String collection, UniqueCoordinationType uniqueCoordinationType) {
        if (uniqueCoordinationType == UniqueCoordinationType.LAYERED_COORDINATION) {
            return switch (collection) {
                case "top" ->
                        List.of("style3", "style2", "style1", "season", "topLength", "fit", "pattern", "brightness", "saturation", "color", "isSeeThrough", "category", "sleeveLength", "isUnique", "isSimple");
                case "pants" ->
                        List.of("style3", "style2", "pantsFit", "bottomLength", "brightness", "saturation", "color", "category", "season", "pattern", "isUnique", "style1");
                case "dress" ->
                        List.of("style3", "style2", "skirtType", "fit", "skirtLength", "isSeeThrough", "brightness", "saturation", "color", "season", "skirtFit", "sleeveLength", "isTopRequired", "pattern", "isUnique", "style1");
                case "skirt" ->
                        List.of("style3", "style2", "skirtFit", "skirtLength", "brightness", "saturation", "color", "season", "skirtType", "pattern", "isUnique", "style1");
                default ->
                        List.of("style3", "style2", "topLength", "fit", "sleeveLength", "isSeeThrough", "brightness", "saturation", "color", "category", "season", "pattern", "isUnique", "style1");
            };
        } else{
            return switch (collection) {
                case "top" ->
                        List.of("style3", "style2", "season", "topLength", "fit", "brightness", "saturation", "color", "isSeeThrough", "category", "sleeveLength", "pattern", "isUnique", "style1", "isSimple");
                case "pants" ->
                        List.of("style3", "style2", "pantsFit", "bottomLength", "brightness", "saturation", "color", "category", "season", "pattern", "isUnique", "style1");
                case "dress" ->
                        List.of("style3", "style2", "skirtType", "fit", "skirtLength", "isSeeThrough", "brightness", "saturation", "color", "season", "skirtFit", "sleeveLength", "isTopRequired", "pattern", "isUnique", "style1");
                case "skirt" ->
                        List.of("style3", "style2", "skirtFit", "skirtLength", "brightness", "saturation", "color", "season", "skirtType", "pattern", "isUnique", "style1");
                default ->
                        List.of("style3", "style2", "topLength", "fit", "isSeeThrough", "brightness", "saturation", "color", "category", "season", "pattern", "isUnique", "style1", "sleeveLength");
            };
        }
    ...
    public String addFeedback(Map<ClothesKey, String> outfit, String feedback, String coordinationRule) throws IOException {
        ...
        for (ClothesKey key : outfit.keySet()) {
            ...
            content.add(Map.of("type", "image_url", "image_url", Map.of("url", value)));
        }
